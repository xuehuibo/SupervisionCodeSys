...
namespace DAL
{
    ...
    public abstract class BaseDAL<T>:SqlServerDll.SqlServerBaseAction
    {
        ...
        public abstract bool Save(T obj,out string msg);
       ...
       /// <param name="msg">返回信息</param>
       /// <returns>是否成功</returns>
        public abstract bool Delete(string id,out string msg);
        ...
        /// <param name="msg">返回信息</param>
        /// <returns>是否成功</returns>
        public abstract bool Select(List<SysInfo.Param> param,int page,int size,out List<T> rst,out int total,out string msg);
